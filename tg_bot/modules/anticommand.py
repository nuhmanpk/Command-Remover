...
__help__ = """
*MAKE SURE THAT I'M A ADMIN IN GROUP AND HAVE PERMISSION TO DELETE MESSAGE*

I remove messages starting with a /command in groups and supergroups.
- /rmcmd <on/off>: when someone tries to send a @bughunter0 message, I will try to delete that!
"""
